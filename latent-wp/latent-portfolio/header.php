...
<div class="chrome top" aria-hidden="true"><span class="mono">&ldquo;<?php bloginfo( 'name' ); ?>.&rdquo;</span><span class="mono"><span class="js-clock" data-tz="<?php echo esc_attr( latent_opt( 'latent_timezone', 'Asia/Amman' ) ); ?>">--:--</span> (<?php echo esc_html( latent_opt( 'latent_gmt', 'GMT+3' ) ); ?>) &nbsp;&nbsp; <a href="<?php echo esc_url( home_url( '/#work' ) ); ?>">[ <?php esc_html_e( 'View work', 'latent' ); ?> ]</a><?php if ( latent_about_url() ) : ?><span class="only-d"> &nbsp; </span><a class="only-d" href="<?php echo esc_url( home_url( '/#about' ) ); ?>">[ <?php esc_html_e( 'About', 'latent' ); ?> ]</a><?php endif; ?></span></div>
