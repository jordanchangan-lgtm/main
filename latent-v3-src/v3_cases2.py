...
if os.environ.get('PRICES')=='5': exec(open(SP+'v3_prices5.py').read())
if os.environ.get('PRICES')=='6': exec(open(SP+'v3_prices6.py').read())
if os.environ.get('PROCESS')=='2': exec(open(SP+'v3_process2.py').read())
if os.environ.get('PROCESS')=='3': exec(open(SP+'v3_process3.py').read())
if os.environ.get('PROCESS')=='4': exec(open(SP+'v3_process4.py').read())
...
if os.environ.get('STAIR')=='1': exec(open(SP+'v3_how6.py').read())
if os.environ.get('KB')=='1': exec(open(SP+'v3_kick.py').read())
