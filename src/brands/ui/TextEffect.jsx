...
// Ported from the provided shadcn/Tailwind/TS `text-effect.tsx` to plain JSX.
// framer-motion is already a project dependency. Tailwind class merging is
// replaced by the local `cn` helper.
