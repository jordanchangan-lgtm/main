...
_edit='''<div class="stage he">
    <p class="he-top js-pu2" style="--d:.1s"><span>Latent.</span><span>Brand visuals<br>&amp; film</span><span>AI-native<br>practice</span><span>Amman<br><span id="clock">--:--</span> GMT+3</span><span>Edition<br>No. 001</span></p>
    <h1 class="he-head js-pu2" style="--d:.25s">Not your<br>average <em>AI.</em></h1>
    <p class="he-sub js-pu2" style="--d:.45s">Directed<br>like film.</p>
    <p class="he-year js-pu2" style="--d:.6s"><span class="logo he-logo" role="img" aria-label="Latent"></span>&copy;20<br>26</p>
    ...
    <span class="he-ratio js-pu2" style="--d:1.08s">60 &middot; 30 &middot; 10</span>
    <a class="he-br js-pu2" href="#prices" style="--d:1.15s">Let&rsquo;s generate &#8599;</a>
    <span class="he-hide"><span class="cyc" id="cyc"></span></span>
  </div>'''
s=s[:_hs]+_edit+s[_he:]
